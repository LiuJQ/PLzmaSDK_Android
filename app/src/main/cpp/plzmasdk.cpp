...
extern "C"
JNIEXPORT jboolean
Java_com_jackin_plzmasdk_PLzmaNativeApis_compress(JNIEnv *env, jobject thiz, jobjectArray file_paths,
                                                      jstring target_path) {
...
extern "C"
JNIEXPORT jboolean
Java_com_jackin_plzmasdk_PLzmaNativeApis_compressDir(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT jboolean
Java_com_jackin_plzmasdk_PLzmaNativeApis_extract(JNIEnv *env, jobject thiz,
